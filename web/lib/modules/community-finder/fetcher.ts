...
const MOCK_LINKEDIN_COMMUNITIES: Community[] = [
  {
    ...
    description: 'Professionals discussing AI, machine learning, and automation applications',
    link: 'https://www.linkedin.com/groups/13507145/',
    memberCount: 512000,
    activityScore: 75,
    relevanceScore: 85,
    competitorPresence: true,
  ...
  },
  {
    ...
    platform: 'linkedin',
    platformId: '1783245',
    name: 'Marketing Professionals & Entrepreneurs',
    description: 'Network for marketers, entrepreneurs, and business growth professionals',
    link: 'https://www.linkedin.com/groups/1783245/',
    memberCount: 89000,
    activityScore: 68,
    relevanceScore: 80,
    competitorPresence: false,
