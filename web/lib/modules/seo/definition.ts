    ...
    // ── 8. Keyword Research ───────────────────────────────────────────────────
    {
      ...
      subCategories: [
        ...
        },
        {
          ...
          items: [
            { slug: 'gsc-top-queries', label: 'Top organic queries driving traffic are known', prompt: 'Using the GSC top queries data provided, summarise the top keyword themes driving impressions. State whether branded or non-branded terms dominate, what this reveals about current search visibility, and what the top opportunity is. If GSC data is not available, explain that connecting the GSC API in Settings → Integrations will unlock this insight.', order: 1, weight: 2 },
            { slug: 'gsc-quick-wins', label: 'Quick win keywords identified (positions 4–20)', prompt: 'Using the GSC quick win keywords provided (positions 4–20), identify the top 3 best opportunities where a focused on-page optimisation could push the ranking onto page 1. For each, state the query, current position, and what specific change would likely move it up. If no quick win data is available, explain that connecting the GSC API in Settings → Integrations will unlock this.', order: 2, weight: 3 },
            { slug: 'gsc-low-ctr', label: 'High impression, low CTR keywords flagged', prompt: 'Using the GSC low CTR keywords provided (high impressions but low click-through rate), identify the top opportunities where improving the title tag or meta description would increase clicks without needing to rank higher. For each, suggest a specific improvement. If no CTR data is available, explain that connecting the GSC API in Settings → Integrations will unlock this.', order: 3, weight: 2 },
          ],
        },
        {
          slug: 'kw-coverage',
