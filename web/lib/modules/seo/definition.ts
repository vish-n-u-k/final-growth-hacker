      ...
      subCategories: [
        {
          ...
          order: 1,
          items: [
            { slug: 'title.present',  label: 'Title tag is present',                  prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
            { slug: 'title.length',   label: 'Title is 50–60 characters',             prompt: 'Rule engine check.', order: 2, weight: 2, fixable: true },
            { slug: 'title.keyword',  label: 'Primary keyword appears in title',      prompt: 'Rule engine check.', order: 3, weight: 2, fixable: true },
            { slug: 'title.unique',   label: 'Title is unique across site',           prompt: 'Rule engine check.', order: 4, weight: 2 },
            { slug: 'title.brand',    label: 'Brand name included in title',          prompt: 'Rule engine check.', order: 5, weight: 1, fixable: true },
          ],
        },
        {
          ...
          order: 2,
          items: [
            { slug: 'description.present',  label: 'Meta description is present',                      prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
            { slug: 'description.length',   label: 'Description is 140–155 characters',               prompt: 'Rule engine check.', order: 2, weight: 2, fixable: true },
            { slug: 'description.keyword',  label: 'Primary keyword in meta description',             prompt: 'Rule engine check.', order: 3, weight: 2, fixable: true },
            { slug: 'description.cta',      label: 'Description includes call-to-action language',   prompt: 'Rule engine check.', order: 4, weight: 1, fixable: true },
        ...
        },
        {
          ...
          order: 3,
          items: [
            { slug: 'canonical.present',      label: 'Canonical tag is present',                       prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
            { slug: 'canonical.same_domain',  label: 'Canonical points to same domain',               prompt: 'Rule engine check.', order: 2, weight: 2, fixable: true },
            { slug: 'canonical.self',         label: 'Canonical is self-referencing',                 prompt: 'Rule engine check.', order: 3, weight: 2, fixable: true },
        ...
        },
        {
          ...
          order: 4,
          items: [
            { slug: 'robots.noindex', label: 'Page is not blocked from indexing', prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
          ],
        },
        {
          slug: 'open-graph',
          ...
          order: 5,
          items: [
            { slug: 'og.title',       label: 'og:title is present',                      prompt: 'Rule engine check.', order: 1, weight: 2, fixable: true },
            { slug: 'og.description', label: 'og:description is present',               prompt: 'Rule engine check.', order: 2, weight: 2, fixable: true },
            { slug: 'og.image',       label: 'og:image is present and accessible',      prompt: 'Rule engine check.', order: 3, weight: 2, fixable: true },
            { slug: 'og.url',         label: 'og:url matches canonical URL',            prompt: 'Rule engine check.', order: 4, weight: 1, fixable: true },
            { slug: 'og.type',        label: 'og:type is declared',                     prompt: 'Rule engine check.', order: 5, weight: 1, fixable: true },
          ],
        },
      ],
    },
      ...
      subCategories: [
        {
          ...
          order: 1,
          items: [
            { slug: 'alt.present',          label: 'All images have alt attributes',                   prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
            { slug: 'alt.not_empty',        label: 'Content images have descriptive alt text',         prompt: 'Rule engine check.', order: 2, weight: 2, fixable: true },
        ...
        },
        {
          ...
          items: [
            ...
            { slug: 'image.lazyload',   label: 'Below-fold images use lazy loading',          prompt: 'Rule engine check.', order: 3, weight: 1, fixable: true },
      ...
      subCategories: [
        {
          ...
          order: 1,
          items: [
            { slug: 'schema.present',          label: 'JSON-LD structured data is present',       prompt: 'Rule engine check.', order: 1, weight: 2, fixable: true },
            ...
            { slug: 'schema.twitter-card',     label: 'Twitter Card meta tags are present',      prompt: 'Rule engine check.', order: 5, weight: 1, fixable: true },
          ],
        },
      ],
    },
    ...
    // ── 6. Technical ──────────────────────────────────────────────────────────
    {
      ...
      subCategories: [
        ...
        },
        {
          ...
          order: 3,
          items: [
            { slug: 'mobile.viewport', label: 'Mobile viewport meta tag is correct', prompt: 'Rule engine check.', order: 1, weight: 3, fixable: true },
          ],
        },
        {
          slug: 'crawlability',
