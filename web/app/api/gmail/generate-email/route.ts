      ...
      <tr>
        <td style="padding:36px 40px 32px;">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="margin:24px 0 20px;">
            <tr>
              <td>
                <a href="${websiteUrl}" style="display:inline-block;padding:12px 28px;background:${color};color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:7px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">${copy.ctaText}</a>
              </td>
            </tr>
          </table>
          ...
          <p style="margin:0;font-size:12px;color:#8a9e90;line-height:1.5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
            ...
            <a href="${websiteUrl}" style="color:${color};text-decoration:underline;">${websiteUrl}</a>
          </p>
