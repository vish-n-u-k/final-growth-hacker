...
export async function PATCH(request: Request) {
  ...
  const body = await request.json() as { unique_filter_enabled?: boolean; unique_filter_property?: string }
  ...
  const updatedMeta = {
    ...
    ...(body.unique_filter_property != null
      ? { unique_filter_property: body.unique_filter_property }
      : {}),
  }
