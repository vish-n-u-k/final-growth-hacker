    ...
    <>
      ...
      <div className="md-layout wrap">
        ...
        <aside className="md-sidebar">
          ...
          <button
            className={`md-sidebar-item md-sidebar-item-utility`}
            onClick={() => router.push('/reminders')}
          >
            <div className="md-sidebar-item-top">
              <span className="md-sidebar-item-name">Reminders</span>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" style={{ color: 'var(--text-faint)', flexShrink: 0 }}>
